...
from dataset import Audio2GeometrywithEnergyPitchDataset
from model import Audio2GeometrywithEnergyPitchModel
...
if __name__ == '__main__':
    ...
    device = opt.device
    dataset = Audio2GeometrywithEnergyPitchDataset(opt)
    ...
    model = Audio2GeometrywithEnergyPitchModel(opt).to(device)
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(tqdm(test_dataloader)):
            ...
            geometry_pred = model(audio_feature, viseme, audio_energy, audio_pitch)
